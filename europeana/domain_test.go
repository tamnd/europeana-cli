...
// HTTP behaviour is covered in europeana_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "europeana://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("europeana", "about")
	if err != nil || got.String() != "europeana://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want europeana://page/about", got.String(), err)
	}
}
