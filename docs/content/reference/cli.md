...
```
europeana <command> [arguments] [flags]
```

Run `europeana <command> --help` for the full flag list on any command. This
...
per operation you declare in `europeana/domain.go`.
